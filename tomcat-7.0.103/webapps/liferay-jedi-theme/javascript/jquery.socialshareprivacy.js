    ...
    $.fn.socialSharePrivacy = function (settings) {
        var defaults = {
            'services' : {
                'facebook' : {
                    'status'            : 'on',
                    'dummy_img'         : '/liferay-jedi-theme/images/socialshareprivacy/dummy_facebook.png',
                ...
                'twitter' : {
                    'status'            : 'on', 
                    'dummy_img'         : '/liferay-jedi-theme/images/socialshareprivacy/dummy_twitter.png',
                ...
                'gplus' : {
                    'status'            : 'on',
                    'dummy_img'         : '/liferay-jedi-theme/images/socialshareprivacy/dummy_gplus.png',
            ...
            'cookie_expires'    : '365',
            'css_path'          : '/liferay-jedi-theme/css/socialshareprivacy.css',
            'uri'               : getURI
        };
